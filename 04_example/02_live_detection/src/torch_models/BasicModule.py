...
class BasicModule(torch.nn.Module):
    ...
    def load(self, path, gpuid=None):
        ...
        if gpuid is None:
            ...
            checkpoint = torch.load(path, map_location={'cuda:0': 'cuda:{}'.format(gpuid)})
...
class MyVggNet11(BasicModule):
    def __init__(self):
        ...
        custom_model = models.vgg11_bn(pretrained=True)
        self.vggnet_lay = nn.Sequential(*list(custom_model.children())[:-1])
...
class MyVggNet13(BasicModule):
    def __init__(self):
        ...
        custom_model = models.vgg13_bn(pretrained=True)
        self.vggnet_lay = nn.Sequential(*list(custom_model.children())[:-1])
        self.fc_Linear_lay2 = nn.Linear(128, 2)
        self.drop = nn.Dropout(0.5)
        self.conv_lay1 = nn.Conv2d(512, 256, kernel_size=(2, 2), stride=(1, 1))
...
class MyVggNet16(BasicModule):
    def __init__(self):
        ...
        custom_model = models.vgg16_bn(pretrained=True)
        self.vggnet_lay = nn.Sequential(*list(custom_model.children())[:-1])
        self.fc_Linear_lay2 = nn.Linear(128, 2)
        self.drop = nn.Dropout(0.5)
        self.conv_lay1 = nn.Conv2d(512, 256, kernel_size=(2, 2), stride=(1, 1))
...
class MyVggNet19(BasicModule):
    def __init__(self):
        ...
        custom_model = models.vgg19_bn(pretrained=True)
        self.vggnet_lay = nn.Sequential(*list(custom_model.children())[:-1])
        self.fc_Linear_lay2 = nn.Linear(128, 2)
        self.drop = nn.Dropout(0.5)
        self.conv_lay1 = nn.Conv2d(512, 256, kernel_size=(2, 2), stride=(1, 1))
...
class MyresNet18(BasicModule):
    def __init__(self):
        ...
        self.resnet_lay = nn.Sequential(*list(custom_model.children())[:-2])
...
class MyInceptionV3(BasicModule):
    def __init__(self):
        ...
        if self.training:
            self.resnet_lay = nn.Sequential(
                *(list(custom_model.children())[:13] + list(custom_model.children())[14:-1]))
        else:
            self.resnet_lay = nn.Sequential(*(list(custom_model.children())[:-1]))
        self.conv1_lay = nn.Conv2d(2048, 512, kernel_size=(1, 1), stride=(1, 1))
        self.relu1_lay = nn.ReLU(inplace=True)
        self.drop_lay = nn.Dropout2d(0.5)
        self.global_average = nn.AdaptiveAvgPool2d((1, 1))
...
class MydenseNet161(BasicModule):
    def __init__(self):
        ...
        custom_model = models.densenet161(pretrained=True)
        self.resnet_lay = nn.Sequential(*list(custom_model.children())[:-1])
...
class MydenseNet169(BasicModule):
    def __init__(self):
        ...
        custom_model = models.densenet169(pretrained=True)
        self.resnet_lay = nn.Sequential(*list(custom_model.children())[:-1])
...
class MydenseNet201(BasicModule):
    def __init__(self):
        ...
        custom_model = models.densenet201(pretrained=True)
        self.resnet_lay = nn.Sequential(*list(custom_model.children())[:-1])
...
class MyseNet10(BasicModule):
    def __init__(self):
        super(MyseNet10, self).__init__()
        custom_model = models.squeezenet1_0(pretrained=True)
        self.resnet_lay = nn.Sequential(*list(custom_model.children())[:-1])
...
class MyseNet11(BasicModule):
    def __init__(self):
        super(MyseNet11, self).__init__()
        custom_model = models.squeezenet1_1(pretrained=True)
        self.resnet_lay = nn.Sequential(*list(custom_model.children())[:-1])
        self.conv1_lay = nn.Conv2d(512, 512, kernel_size=(1, 1), stride=(1, 1))
        self.relu1_lay = nn.ReLU(inplace=True)
        self.drop_lay = nn.Dropout2d(0.5)
...
class Myxception(BasicModule):
    def __init__(self):
        ...
        from torch_models.xception import xception
        custom_model = xception(pretrained=True)
        self.resnet_lay = nn.Sequential(*list(custom_model.children())[:-1])
        self.conv1_lay = nn.Conv2d(2048, 512, kernel_size=(1, 1), stride=(1, 1))
        self.relu1_lay = nn.ReLU(inplace=True)
        self.drop_lay = nn.Dropout2d(0.5)
...
class MydetNet59(BasicModule):
    def __init__(self):
        ...
        from torch_models.detnet import detnet59
        custom_model = detnet59(pretrained=True)
        self.resnet_lay = nn.Sequential(*list(custom_model.children())[:-2])
        self.conv1_lay = nn.Conv2d(1024, 512, kernel_size=(1, 1), stride=(1, 1))
        self.relu1_lay = nn.ReLU(inplace=True)
        self.drop_lay = nn.Dropout2d(0.5)
...
class MynasNet(BasicModule):
    def __init__(self):
        ...
        from torch_models.nasnet import NASNetALarge
